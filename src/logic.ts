...
const nouns: string[] = ['order', 'butter', 'ticket', 'smoke', 'birds', 'rock', 'wing', 'fog', 'sky', 'water', 'cream', 'bikes', 'shoes', 'vegetable', 'cow', 'fork', 'haircut', 'waves', 'dinosaurs', 'blood', 'servant', 'structure', 'party', 'clown', 'pen', 'throat', 'frogs', 'earthquake', 'card', 'toothpaste', 'spy', 'worm', 'activity', 'truck', 'potato', 'office', 'island', 'bottle', 'fairies', 'maid', 'needle', 'squirrel', 'cherry', 'stone', 'advertisement', 'bells', 'kittens', 'deer', 'hobbies', 'river', 'bubble', 'soup', 'cemetery', 'coal', 'crime', 'sugar', 'thunder', 'grandfather', 'ants', 'steam', 'aftermath', 'hair', 'respect', 'wound', 'ground', 'door', 'gold', 'wish', 'fire', 'ring', 'dogs', 'theory', 'watch', 'machine', 'soda', 'star', 'locket', 'name', 'berry', 'castle', 'reward', 'pollution', 'talk', 'school', 'reaction', 'celery', 'canvas', 'car', 'airplane', 'pet', 'cakes', 'grass', 'breath', 'hand'];
